...
Here are a lot of files. 

The purpose of this project is to map the human brain and create code that will run like the brain on a computer.
...
Kytherea is to be the same project, but only with computer science and electrical engineering terms in it.
...
C371, human brain description and data flow and Brain architecture, Opus 5 High.txt

Suggestions are welcome, but I do not accept code.
